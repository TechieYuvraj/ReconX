...
class WatermarkPDF(FPDF):
        def header(self):
            self.set_text_color(200, 200, 200)  # Light gray for watermark
            self.set_font("Arial", "B", 40)
            self.rotate(20, x=20, y=20)
            positions = [(0, 100), (0, 150), (0, 200), (0, 250)]
            for x, y in positions:
                self.text(x, y, "Generated by ReconX -")
                self.text(x, y + 15, "For Educational Use Only")
            self.rotate(0)
